...
/**
 * Servlet implementation class RegistroUsuarios_post
 */
@WebServlet("/RegistroUsuarios_post")
public class RegistroUsuarios_post extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RegistroUsuarios_post() {
        super();
