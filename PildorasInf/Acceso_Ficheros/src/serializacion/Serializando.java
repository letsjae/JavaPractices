...
public class Serializando {
	...
	public static void main(String[] args) {
		...
		try {
//     		ObjectOutputStream escribiendoFichero=new ObjectOutputStream(new FileOutputStream("src/empleado"));
//			
//			escribiendoFichero.writeObject(personal);
//			
//			escribiendoFichero.close();
			
			ObjectInputStream recuperandoFichero= new ObjectInputStream(new FileInputStream("src/empleado"));
